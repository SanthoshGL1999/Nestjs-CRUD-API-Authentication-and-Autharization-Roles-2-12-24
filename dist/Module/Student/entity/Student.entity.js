...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Teacher_entity_1.TEACHERS, (teacher) => teacher.student),
    (0, typeorm_1.JoinColumn)({ name: 'CLASS_TEACHER' }),
    __metadata("design:type", Teacher_entity_1.TEACHERS)
], STUDENTS.prototype, "teacher", void 0);
__decorate([
    (0, typeorm_1.OneToMany)(() => Mark_entity_1.MARKS, (marks) => marks.students),
    __metadata("design:type", Array)
], STUDENTS.prototype, "marks", void 0);
__decorate([
    (0, typeorm_1.OneToOne)(() => project_entity_1.PROJECT, (project) => project.student),
    __metadata("design:type", Array)
